...
import { AuthContext } from '../../context/AuthContext'; // Corrected import of AuthContext
import { BiMenu } from "react-icons/bi";
import { useNavigate } from "react-router-dom";

const Tabs = ({ tab, setTab }) => {
  // Correctly using AuthContext
  const { dispatch } = useContext(AuthContext);  // <-- This line is now using AuthContext
